...
const AlbumList = ({ albums, selectedAlbum, onAlbumClick, title }) => {
    ...
    return (
        <div className="mt-8 w-full flex flex-col items-center">
            ...
            <div className="w-[85%] bg-gradient-to-br from-white/5 via-white/10 to-white/5 rounded-2xl p-6 shadow-inner backdrop-blur-md">
            <div className="flex flex-col sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 transition-all">
